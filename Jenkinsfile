    ...
    stages {
        ...
        stage('Checkout from Git') {
         ...
         stage("Sonarqube Analysis") {
			...
			sh 'sonar-scanner   -Dsonar.projectKey=lab_cicd   -Dsonar.sources=.   -Dsonar.host.url=http://54.215.81.76:9000   -Dsonar.login=sqp_c9d5aa06e36b6816005c9dc5368c9b5c8de25f29'
                }
            }
